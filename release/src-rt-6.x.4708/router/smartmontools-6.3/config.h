...
#define CONFIG_H_CVSID "$Id: configure.ac 3976 2014-07-26 09:50:09Z chrfranke $"
...
#define PACKAGE_STRING "smartmontools 6.3"
...
#define SMARTMONTOOLS_CONFIGURE_ARGS " '--host=arm-linux' '--build=x86_64-suse-linux' '--prefix=/usr' 'build_alias=x86_64-suse-linux' 'host_alias=arm-linux' 'LDFLAGS=-static' 'CC=arm-brcm-linux-uclibcgnueabi-gcc' 'CFLAGS=-DBCMWPA2 -DBCMQOS -DBCM_DCS -DEXT_ACS -DD11AC_IOTYPES -DNAS_GTK_PER_STA -DPHYMON -DPROXYARP -DTRAFFIC_MGMT -DTRAFFIC_MGMT_RSSI_POLICY -DLINUX26 -DCONFIG_BCMWL5 -DCONFIG_BCMWL6 -DCONFIG_BCMWL6A -DPART_JFFS2_GAP=0UL -pipe -fno-strict-aliasing -DBCMWPA2 -DBCMARM -marm  -DTCONFIG_NVRAM_64K -DLINUX_KERNEL_VERSION=132644 -O2 -D__CONFIG_EMF__'"

/* smartmontools Release Date */
#define SMARTMONTOOLS_RELEASE_DATE "2014-07-26"

/* smartmontools Release Time */
#define SMARTMONTOOLS_RELEASE_TIME "09:49:11 UTC"
