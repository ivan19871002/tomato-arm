...
/* MULTIWAN-END */
	...
	{ title: '<% translate("Check connections every"); %>', name: 'mwan_cktime', type: 'select', options: [
		...
		suffix: ' <small>(<% translate("Default: 2 minutes, when the network conditionsis poor, try use long detection period"); %>)</small>',
