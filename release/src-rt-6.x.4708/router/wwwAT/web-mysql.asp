	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<script type="text/javascript">
			...
			$('#mysql-basic-set').forms([
				...
				{ title: '<% translate("Delay at startup"); %>', name: 'mysql_sleep', type: 'text', maxlen: 5, size: 7, value: nvram.mysql_sleep, suffix: ' <small>seconds (<% translate("range"); %>: 1 - 60; <% translate("default"); %>: 2)</small>' },
				...
				{ title: '<% translate("Allow Anyhost to access"); %>', name: 'f_mysql_allow_anyhost', type: 'checkbox', value: nvram.mysql_allow_anyhost == 1, suffix: ' <small>Allowed any hosts to access database server.</small>' },
				{ title: '<% translate("Re-init priv. table"); %>', name: 'f_mysql_init_priv', type: 'checkbox', value: nvram.mysql_init_priv== 1, suffix: ' <small>If checked, privileges table will be forced to re-initialize by mysql_install_db.</small>' },
				{ title: '<% translate("Re-init root password"); %>', name: 'f_mysql_init_rootpass', type: 'checkbox', value: nvram.mysql_init_rootpass == 1, suffix: ' <small>If checked, root password will be forced to re-initialize.</small>' },
				{ title: '<% translate("root user name"); %>', name: 'mysql_username', type: 'text', maxlen: 32, size: 16, value: nvram.mysql_username, suffix: ' <small>user name connected to server.(default: root)</small>' },
				{ title: '<% translate("root password"); %>', name: 'mysql_passwd', type: 'password', maxlen: 32, size: 16, peekaboo: 1, value: nvram.mysql_passwd, suffix: ' <small>not allowed NULL.(default: admin)</small>' },
