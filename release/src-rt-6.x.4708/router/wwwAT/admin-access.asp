			...
			<div class="content" id="section-gui">
				...
				<script type="text/javascript">
					var m = [
						...
						{ title: '<% translate("Default Navigation State"); %>', name: 'at_navi', type: 'select', help: 'You can always toggle navigation style by clicking an icon right to logo, but doing so won\'t change default state.',
						...
						{ title: '<% translate("Web GUI directory"); %>', name: 'web_dir', type: 'select', help: 'Experts only! This will change directory from which Tomato Web handler is reading the interface files from. You should only change this if you have another interface in specific directory',
