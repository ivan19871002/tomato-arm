...
<li><% translate("By definition, configuration settings for the"); %> <i><% translate("primary VIF"); %></i> <% translate("of any physical wireless interfaces shouldn't be touched here"); %> (<% translate("use the"); %> <a href=basic-network.asp><% translate("Basic"); %>/<% translate("Network"); %></a> <% translate("page instead"); %>).</li>
</ul>
</ul>
</small>
